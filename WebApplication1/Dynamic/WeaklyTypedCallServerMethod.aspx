<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeaklyTypedCallServerMethod.aspx.cs" Inherits="WebApplication1.Dynamic.WeaklyTypedCallServerMethod" %>
...
<head runat="server">
    ...
    <script>
        ...
        function GetCurrentUserInfo(JSonObj) {
            ...
            global_old_password = JSonObj.my_password;
        ...
        $(document).ready(function () {
            ...
            //获取当前用户的信息。
            CallMethodToGetJsonObj("para", "", "WeaklyTypedCallServerMethod.aspx", "GetCurrentUserInfo", GetCurrentUserInfo);
        ...
        function submit_event()
        {
            ...
            CallMethodToGetJsonObj("NewPassword", new_psw1, "WeaklyTypedCallServerMethod.aspx", "ChangeNewPassword", after_password_changed_event);
        }
    </script>
