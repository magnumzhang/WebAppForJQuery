<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostJsonThenGetItChange.aspx.cs" Inherits="WebApplication1.DemoFolder.PostJsonThenGetItChange" %>
...
<head runat="server">
    ...
    <script>
        ...
        function p_click_event() {
            ...
            $.ajax({
                type: "Post",
                url: "PostJsonThenGetItChange.aspx/PostJson",
                //如果传入的数据是字符串，需要加上单引号
